@echo off
echo ================================================
echo ORM Maps Tools - EXE Builder
echo ================================================
echo.
...
echo Erstelle EXE-Datei für ORM Maps Tools...
echo.
%PYTHON_CMD% -m PyInstaller --onefile --windowed --name "ORM-Maps-Tools" --clean orm-maps-tools.py
...
echo ================================================
echo.
echo EXE-Datei: dist\ORM-Maps-Tools.exe
echo.
