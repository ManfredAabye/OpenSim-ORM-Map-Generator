@echo off
echo ================================================
echo ORM Maps Viewer - EXE Builder
echo ================================================
echo.
...
echo Erstelle EXE-Datei für ORM Maps Viewer...
echo.
%PYTHON_CMD% -m PyInstaller --onefile --windowed --name "ORM-Maps-Viewer" --clean orm-maps-viewer.py
...
echo ================================================
echo.
echo EXE-Datei: dist\ORM-Maps-Viewer.exe
echo.
